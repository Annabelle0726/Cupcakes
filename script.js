...
function showFlavorOfDay() {
  let flavorObject = findFlavorObject();
  let featuredCupcakeImage = document.getElementById('featured-cupcake-img');
  featuredCupcakeImage.src = flavorObject.img;
  let featuredCupcakeName = document.getElementById('featured-cupcake-name');
  featuredCupcakeName.innerText = flavorObject.name;
}
